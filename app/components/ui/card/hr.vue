		...
		<v-col cols="12" md="6">
			<div class="pa-5">
				...
				<p
					...
					v-html="$t(`products.hr.cards.one.title`)"
				></p>
				...
				<div class="mt-5">
					<h4 class="text-h6">
						{{ $t("products.hr.cards.one.subtitle") }}
					</h4>
					<div
